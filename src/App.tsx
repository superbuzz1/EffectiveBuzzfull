      ...
      <div className="max-w-[1500px] mx-auto w-full px-4 sm:px-6 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 py-8">
        ...
        <aside className="lg:col-span-3 lg:sticky lg:top-24 h-fit bg-[#0d131f] border border-[#1f2937] rounded-xl p-4 space-y-5 shadow-xl">
          ...
          <nav className="space-y-1.5">
            {[
              ...
              { id: 'team_billing', label: '11.8 Team Billing & Seats', icon: Building2, desc: 'Enterprise multiseat Stripe management' },
              { id: 'pipeline_forecasting', label: '11.9 Pipeline AI', icon: TrendingUp, desc: 'AI-driven pipeline and revenue forecasting.' },
              { id: 'lead_enrichment', label: '11.10 Lead Scraping Engine', icon: Database, desc: 'Web scraping and Clearbit verification pipeline' },
              { id: 'nlp_sentiment', label: '11.11 NLP Sentiment Router', icon: MessageSquare, desc: 'Classify replies into Positive, Objection, OOO' },
              { id: 'anthropic_caching', label: '11.12 Prompt Caching', icon: Cpu, desc: 'Save 50% LLM cost by caching Context' },
              { id: 'soc2_compliance', label: '11.13 SOC 2 & SecOps', icon: ShieldCheck, desc: 'Enterprise security, audit logs, and RLS visualization' },
        ...
        <main className="lg:col-span-9 space-y-6">
          <div className="bg-[#0d131f] border border-[#1f2937] p-6 lg:p-8 rounded-2xl shadow-2xl relative overflow-hidden">
            ...
            {activeTab === 'executive_execution_report' && (
              <ExecutiveExecutionReport />
            )}
